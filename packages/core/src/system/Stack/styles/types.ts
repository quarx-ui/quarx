...
export interface StackStyleParams {
     ...
     *
     * - **column** – элементы расположены на вертикальной оси
     * - **row** – элементы расположены на горизонтальной оси
     *
     * @default column */
     ...
     *
     * - **default** – расположение элементов в стандартном порядке
     * - **reverse** – расположение элементов в обратном порядке
     *
     * @default default */
    order: StackOrder;
