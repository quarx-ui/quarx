...
import { OVER_SCREEN_APPEARANCE, OVER_SCREEN_PLACEMENT, Modal } from '@core/components';
import { MODAL_SCROLL_BEHAVIOR } from '@core/components/main/Modal/constants';
import { FooterBlockStyleKeys } from '@core/components/system/FooterBlock/styles';
