import {
    DatePickerStyleKeys, DatePickerStyleParams,
    DatePickerTEXTS,
    PickerSelectedDate,
    SelectedDates,
    TextFieldProps, WithClassesAndStyles,
} from '@core';
import { PopupDatePickerProps } from '@core/src/main/DatePicker/Wrappers/PopupDatePicker/types';
import { TextFieldDatePickerStyleKeys } from '@core/src/main/DatePicker/Wrappers/TextFieldDatePicker/styles';
...
{
    /** Внешняя ошибка, которая будет отображаться даже при существующих внутренних ошибках */
    errorText?: string;
