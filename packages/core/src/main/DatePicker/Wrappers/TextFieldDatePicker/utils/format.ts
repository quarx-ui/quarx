...
export const getMask = (isPickerType: boolean, withTime: DatePickerProps['withTime']) => getPlaceholder(isPickerType, withTime).split('').filter((symbol) => symbol.match(/[ДМГЧ]/g));
