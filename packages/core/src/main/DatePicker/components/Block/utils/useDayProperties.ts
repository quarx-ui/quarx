import {
    ...
    DatePickerTimeTypes, isPeriod, isPicker, SelectedDates,
} from '@core';
import {
    isAfter,
    isBefore,
...
export type UseDayProperties = <D extends SelectedDates>(props: UseDayPropertiesProps<D>) => UseDayPropertiesReturn

export const mapPeriodAndHoverValues = <D extends SelectedDates>(
    dates?: D,
    hoveredDay?: Date,
...
export const useDayProperties = <D extends SelectedDates>({ day, selected, hoveredDay, viewingDate,
