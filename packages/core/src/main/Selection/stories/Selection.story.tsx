...
import { CheckboxSelection } from '@core/src/main/Checkbox/CheckboxSelection';
import { RadioButtonSelection } from '@core/src/main/RadioButton/RadioButtonSelection';
import { BASE_ARG_TYPES } from '@core/storybook/BASE_ARG_TYPES';
import { DisplayVariants } from '@core/storybook/DisplayVariants';
import { defineCategory, excludeProp } from '@core/storybook/templateParams';
import { SwitcherSelection } from '@core/src/main/Switcher/SwitcherSelection';
...
export default {
    title: STORY_PATHS.core.components.main('Selection'),
    component: Selection,
