...
Так же компонент реализует синхронизацию следующих одинаковых свойств:
* size
* color
* disabled

Синхронизация реализуется по принципам, описанным в 
[manuals/Перезапись свойств дочернего компонента](../?path=/docs/manuals--overwriting-properties)
`;
