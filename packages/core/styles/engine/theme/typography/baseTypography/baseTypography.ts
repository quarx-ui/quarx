...
import { BaseTypographyObject, CreateBaseTypographyOptions } from './types';
import {
...
export const baseTypography: BaseTypographyObject = createBaseTypography();
